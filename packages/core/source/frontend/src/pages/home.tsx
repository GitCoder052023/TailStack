      ...
      <section className="relative overflow-hidden border-b">
        ...
        <div className="container relative flex flex-col items-center justify-center gap-4 py-20 md:py-28 lg:py-36">
          ...
          <p className="max-w-[750px] text-center text-base text-muted-foreground sm:text-lg md:text-xl">
            A production-grade monorepo architecture template for ERN Stack.
            Built with React, Express, Node.js, TypeScript, and Tailwind CSS.
      ...
      <section className="container py-16 md:py-24 lg:py-32">
        <div className="mx-auto flex max-w-[58rem] flex-col items-center justify-center gap-4 text-center">
          ...
          <p className="max-w-[85%] text-muted-foreground sm:text-lg">
            This template includes everything you need to build modern full-stack applications.
          </p>
        </div>
        ...
        <div className="mx-auto mt-12 grid max-w-5xl gap-6 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <FeatureCard
            ...
            title="Weather Demo"
            description="Full-stack weather application showcasing the complete request flow from frontend to backend."
          />
          <FeatureCard
...
function QuickLinkCard({ title, description, href, icon, external }: QuickLinkCardProps) {
  const content = (
    <div className="group relative flex flex-col gap-3 rounded-lg border bg-background p-6 transition-all hover:border-foreground/20 hover:shadow-sm">
